    ...
    const loadInvoiceData = async () => {
      try {
        ...
        if (invoice.status !== "VALIDÉ" && invoice.status !== "PAYÉ") {
          toast.error(
            "Seules les factures validées ou payées peuvent être rectifiées"
          );
          router.push("/dashboard/invoices");
          return;
        }
      ...
      <div className="flex flex-col gap-1">
        <div className="flex mb-6 items-center gap-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground text-sm">
              Correction de la facture {invoiceData.invoiceNumber}. Modifiez les
        ...
        <div className="mt-2 bg-blue-50 border border-blue-200 rounded-lg p-3">
          <p className="text-xs text-blue-700">
            <strong>Info :</strong> La facture originale restera inchangée pour
            la traçabilité fiscale. Une nouvelle facture sera créée avec les
